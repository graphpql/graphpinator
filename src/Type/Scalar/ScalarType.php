    ...
    \Graphpinator\Type\Contract\Resolvable
{
    ...
    public function resolveFields(?\Graphpinator\Request\FieldSet $requestedFields, \Graphpinator\Request\ResolveResult $parentResult) : \Graphpinator\Value\ValidatedValue
    {
