...
abstract class LeafValue implements \Graphpinator\Value\InputedValue, \Graphpinator\Value\OutputValue
{
    ...
    public function __construct(protected \Graphpinator\Type\Contract\LeafType $type, protected mixed $rawValue, bool $inputed)
    {
    ...
    public function getType() : \Graphpinator\Type\Contract\LeafType
    {
        return $this->type;
    }
