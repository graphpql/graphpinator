...
final class InputObjectRepresentation extends \PHPUnit\Framework\TestCase
{
    public function testInputObject() : void
    {
        $request = Json::fromNative((object) [
            'query' => 'query queryName { field1(arg: {name: "foo", number: [123], bool: false, simpleInput2: {name: "foo", number: [123], bool: false} }) }',
        ]);
            ...
            protected function getFieldDefinition() : \Graphpinator\Field\ResolvableFieldSet
            {
                return new \Graphpinator\Field\ResolvableFieldSet([
                    (new \Graphpinator\Field\ResolvableField(
                        ...
                        function($parent, \Graphpinator\Tests\Feature\InputObject $arg) : int {
                            \assert($arg->simpleInput2 instanceof \Graphpinator\Tests\Feature\InputObject2);

                            return $arg->number[0] + $arg->number[0];
                        },
