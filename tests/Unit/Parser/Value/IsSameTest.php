...
final class IsSameTest extends \PHPUnit\Framework\TestCase
{
    public function simpleDataProvider() : array
    {
        return [
            ...
            [new \Graphpinator\Parser\Value\ListVal([]), new \Graphpinator\Parser\Value\ListVal([
            ...
            [new \Graphpinator\Parser\Value\ObjectVal([]), new \Graphpinator\Parser\Value\ObjectVal([
            ...
            [new \Graphpinator\Parser\Value\Literal(123), new \Graphpinator\Parser\Value\ListVal([
                new \Graphpinator\Parser\Value\Literal(123),
            ]), false],
            [new \Graphpinator\Parser\Value\Literal(123), new \Graphpinator\Parser\Value\ObjectVal([
            ...
            [new \Graphpinator\Parser\Value\Literal(123.123), new \Graphpinator\Parser\Value\ListVal([
                new \Graphpinator\Parser\Value\Literal(123.123),
            ]), false],
            [new \Graphpinator\Parser\Value\Literal(123.123), new \Graphpinator\Parser\Value\ObjectVal([
            ...
            [new \Graphpinator\Parser\Value\Literal(true), new \Graphpinator\Parser\Value\ListVal([
                new \Graphpinator\Parser\Value\Literal(true),
            ]), false],
            [new \Graphpinator\Parser\Value\Literal(true), new \Graphpinator\Parser\Value\ObjectVal([
